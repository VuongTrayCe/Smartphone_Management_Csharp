...
namespace Smartphone_Management.DAO
{
    internal class thongTinPhieuNhap_DAO
    {
        ...
        internal DataTable getChiTietThongTinPhieuNhap(int maphieunnhap)
        {
            ...
            string query = "select chitietphieunhap.Masp, sanpham.Tensp, chitietphieunhap.GiaNhap,chitietphieunhap.Soluong,(chitietphieunhap.GiaNhap*chitietphieunhap.Soluong) as TongTien from chitietphieunhap,phieunhap,sanpham where phieunhap.Maphieunhap=chitietphieunhap.Maphieunhap and sanpham.Masp=chitietphieunhap.Masp and phieunhap.Maphieunhap=@mapn";

            MySqlCommand MyCommand2 = new MySqlCommand(query, this.data.getConnection());
            MyCommand2.Parameters.AddWithValue("@mapn",maphieunnhap);
            //  MyConn2.Open();
